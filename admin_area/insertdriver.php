...
<link rel="shortcut icon" type="x-icon" href="zinara-logo.jpg">
      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          ...
          <div class="style3">
            ...
            <div class="form_row">
              <label class="contact"><strong>User ID:</strong></label>
              <input type="number" class="contact_input" name="user_id" required />
            </div>
